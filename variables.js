...
MiyoFilters.variables_initialize = function(argument, request, id) {
  this.variables = {};
...
MiyoFilters.variables_load = function(argument, request, id) {
  this.variables_load(argument.variables_load);
  return argument;
};

MiyoFilters.variables_save = function(argument, request, id) {
...
//# sourceMappingURL=variables.map
